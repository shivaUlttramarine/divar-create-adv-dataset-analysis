...
Here I am orying to find order of actions  each user made to identify master patterns
by this mean I am adding some auxillary fields:
...
Pivoting all the stats of a user form "Start" point of his Journey to the "End" point.
